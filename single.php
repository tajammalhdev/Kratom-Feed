...
<main id="main-content">
	...
	<div class="border-b border-pg-border bg-pg-gray-light lg:hidden">
		<div class="pg-container py-4">
			<button id="mobile-toc-toggle" type="button" class="flex w-full items-center justify-between rounded-xl border border-pg-border bg-white px-4 py-3 text-sm font-bold uppercase cursor-pointer" aria-expanded="false" aria-controls="mobile-toc"><?php esc_html_e( 'On this page', 'kratom-feed' ); ?> <span>â–¼</span></button>
