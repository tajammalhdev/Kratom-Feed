	...
	<header class="bg-pg-black">
		<div class="container py-8 md:py-12">
			...
			<a
				...
				class="mb-2 inline-flex h-8 items-center gap-2 rounded-md border border-pg-lime/70 bg-neutral-950 px-3 transition-colors hover:border-pg-lime hover:bg-neutral-900"
			>
				...
				<ul class="m-0 flex list-none flex-wrap items-center gap-2 p-0">
					...
					<li>
						<a
							...
							class="group inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/5 px-3 py-1.5 text-xs font-medium text-neutral-200 transition-all hover:border-pg-lime/50 hover:bg-pg-lime/10 hover:text-pg-lime"
						>
							<span class="text-pg-lime/80 transition-colors group-hover:text-pg-lime" aria-hidden="true">#</span>
